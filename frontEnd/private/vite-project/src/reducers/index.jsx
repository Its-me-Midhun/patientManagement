...
const functionReducer = (state = initialStateFunction, action) => {
  switch (action.type) {
    ...
    case "FETCH_DATA_CONSULTATION_CERTIFICATE":{
      return{
        ...state,
        issuedConsultationCertificate:action.payload
      }
    }
    case "FETCH_DATA_VACCINATION_CERTIFICATE":{
      return{
        ...state,
        issuedVaccinationCertificate:action.payload
      }
    }
    default:
      return state;
