...
export const getIssuedConsultationCertificates = (navigate) => async (dispatch) => {
  let { data } = await getData('/certificates/consultationcertificate');
  console.log('getIssuedConsultationCertificates', data);
  if (data.success) {
    dispatch({
      type: 'FETCH_DATA_CONSULTATION_CERTIFICATE',
      payload: data.data,
    });
    dispatch(setSuccessMessage('Data retrieval success'));
  } else {
...
export const getIssuedVaccinationCertificates = (navigate) => async (dispatch) => {
  let { data } = await getData('/certificates/vaccinationcertificate');
  console.log('getIssuedVaccinationCertificates', data);
  if (data.success) {
    dispatch({
      type: 'FETCH_DATA_VACCINATION_CERTIFICATE',
      payload: data.data,
    });
    dispatch(setSuccessMessage('Data retrieval success'));
  } else {
