...
import IssuedConsultationCertificatePage from './issuedCertificates/issuedConsultationCertificates';
    ...
    <div>
      ...
      <div>
        <Routes>
          ...
          <Route exact path="/issuedConsultations" element={<IssuedConsultationCertificatePage />}></Route>
